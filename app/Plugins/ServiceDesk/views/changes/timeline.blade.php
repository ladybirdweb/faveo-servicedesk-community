...
if ($change->getGeneralByIdentifier('reason')) {
    ...
    $title = "Delete reason";
    $delete_reason_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid, $delete_reason_url, $title, "fa fa-remove", " ");
}
...
if ($change->getGeneralByIdentifier('rollout-plan')) {
    ...
    $delete_rollout_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid, $delete_rollout_url, $title, "fa fa-remove", " ");
}
if ($change->getGeneralByIdentifier('backout-plan')) {
    ...
    $delete_backout_popup = \App\Plugins\ServiceDesk\Controllers\Library\UtilityController::deletePopUp($popid, $delete_backout_url, $title, "fa fa-remove", " ");
}
?>
<div class="row">
