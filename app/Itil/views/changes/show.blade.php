    ...
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{url('service-desk/changes/'.$change->id.'/edit')}}">{{Lang::get('itil::lang.edit')}}</a></li>
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                ...
                $detach_pop = \App\Itil\Controllers\UtilityController::deletePopUp($id, $url, $title," ","Deatach ".str_limit($change->release()->subject,5),false);
                echo $detach_pop;
                ...
                $delete_pop = \App\Itil\Controllers\UtilityController::deletePopUp($delete_changeid, $delete_change_url, $delete_change_title," "," ",false);
                echo $delete_pop;
                ?>
                @endif
