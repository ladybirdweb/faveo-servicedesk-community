...
if ($problem->getGeneralByIdentifier('root-cause')) {
    ...
    $delete_root_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_root_url, $title, "fa fa-remove", " ");
}
if ($problem->getGeneralByIdentifier('symptoms')) {
    ...
    $delete_symptoms_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_symptoms_url, $title, "fa fa-remove", " ");
}
...
if ($problem->getGeneralByIdentifier('solution')) {
    ...
    $delete_solution_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_solution_url, $title, "fa fa-remove", " ");
}
