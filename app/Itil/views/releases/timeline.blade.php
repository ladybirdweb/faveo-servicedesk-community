...
if ($release->getGeneralByIdentifier('build-plan')) {
    ...
    $delete_build_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_reason_url, $title, "fa fa-remove", " ");
}
if ($release->getGeneralByIdentifier('test-plan')) {
    ...
    $delete_test_popup = \App\Itil\Controllers\UtilityController::deletePopUp($popid, $delete_impact_url, $title, "fa fa-remove", " ");
}
?>
<div class="row">
